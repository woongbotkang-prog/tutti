...
| `v23-24` | 2026-02-19 | **🔒 보안 취약점 수정** — respondToApplication 권한 검증, 만료 공고 지원 차단, 콘솔 로그 민감정보 제거 |
| `v25-26` | 2026-02-19 | **💬 실시간 채팅 안정화** — Supabase Realtime 구독 강화(useMemo), 연결 상태 표시, 로딩 스켈레톤, 메시지 길이 제한 |
| `v27-29` | 2026-02-19 | **♿ 보안/성능/접근성** — 디버그 엔드포인트 보호, N+1 쿼리 최적화, ARIA 레이블, 매너온도 툴팁 |
